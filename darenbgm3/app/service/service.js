 ...
 * 待审核
 */
app.controller('ServicetochenkCtrl', ["$scope", "$cookies", 'toaster', '$http', '$stateParams',
    function ($scope, $cookies, toaster, $http, $stateParams) {
    ...
    $scope.search = function (type) {
        ...
        $http({
                "method": "get",
                "url": "/",//url + "/v1.0/admin/services?" + params,
                "headers": {
                    "access_token": user_token
                }
            }).success(function (json) {
                var datas = {"services":[{"id": "0","image":"","name":"jj","sex":"male","phone":"11122223333",
                "time":"0000 00:00:00","state":"normal"}],
                "pagination": {"total_rows": 1, "capacity": 20, "page": 1, "total": 1}}
                $scope.services = datas.services;
    ...
    $scope.changeInfoBtn = function(id){
        ...
        var row = findCourse(services, id);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
/* 所有服务*/
app.controller('ServiceCtrl', ["$scope", "$cookies", 'toaster', '$http',
    ...
    $scope.changeInfoBtn = function(id){
        var services = $scope.services;
        var master = findCourse(services, id);
