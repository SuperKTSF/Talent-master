...
app.controller('OrderCtrl', ["$scope", "$cookies", 'toaster', '$http','$stateParams',
    ...
    if($stateParams.id != null){
        $scope.nameSearch = $stateParams.id;
    }

    $scope.orderNavLiClick = function(obj, f){
        $("#orderNav>.active").removeClass("active");
    ...
    $scope.search = function (type) {
        ...
        $http({
                ...
                var datas = {"orders":[{"id": "0","image":"","name":"jj","sex":"male","phone":"11122223333",
                "time":"0000 00:00:00","state":"normal"}],
                "pagination": {"total_rows": 1, "capacity": 20, "page": 1, "total": 1}};
                $scope.orders = datas.orders;
